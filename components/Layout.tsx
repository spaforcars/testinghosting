    ...
    <div className="min-h-screen flex flex-col bg-brand-white">
        ...
        <div className="flex justify-between items-stretch h-14 md:h-16">
          ...
          <Link to="/" className="flex items-center px-6 border-r border-brand-black bg-brand-white hover:bg-brand-black hover:text-white transition-colors group">
            <span className="font-display font-bold text-2xl md:text-3xl tracking-tighter uppercase">
              <span className="text-brand-mclaren group-hover:text-white">SPA</span> FOR <span className="text-brand-mclaren group-hover:text-white">CARS</span>
            </span>
          </Link>
          ...
          <nav className="hidden md:flex items-stretch">
            ...
            <Link 
              to="/booking" 
              className="flex items-center justify-center px-6 lg:px-8 border-r border-brand-black bg-brand-black text-brand-mclaren text-xs font-mono uppercase tracking-widest hover:bg-brand-mclaren hover:text-white transition-colors"
            >
              Book Now
            </Link>
          </nav>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-brand-black animate-fade-in bg-brand-white">
            ...
            <Link 
              to="/booking" 
              onClick={() => setIsMobileMenuOpen(false)}
              className="block p-4 border-b border-brand-black font-display text-2xl uppercase font-bold bg-brand-mclaren text-white hover:bg-orange-600 hover:pl-6 transition-all"
            >
              Book Now
            </Link>
          </div>
      ...
      <footer className="border-t border-brand-black bg-brand-white">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center p-2 text-[10px] font-mono uppercase tracking-widest bg-brand-white">
          ...
          <span className="font-bold text-lg my-2 md:my-0"><span className="text-brand-mclaren">SPA</span> FOR <span className="text-brand-mclaren">CARS</span></span>
