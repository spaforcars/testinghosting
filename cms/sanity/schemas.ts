...
export const homePage = {
  ...
  fields: [
    ...
    { name: 'galleryImages', type: 'array', of: [{ type: 'url' }] },
...
export const aboutPage = {
  ...
  fields: [
    ...
    { name: 'image', type: 'url', title: 'Main Image URL' },
      ...
      of: [
        {
          ...
          fields: [
            { name: 'label', type: 'string' },
            { name: 'beforeImage', type: 'url', title: 'Before Image URL' },
            { name: 'afterImage', type: 'url', title: 'After Image URL' },
          ],
        },
      ],
    },
